...
export const companylistReducer = (state={companies:[]}, action)=>{
    switch(action.type){
        ...
        case GET_COMPANYLIST_SUCCESS:
            return {...state, loading:false, companylist:action.payload.companies, totalElement:action.payload.totalElement, totalPage:action.payload.totalPage}
...
export const companyReducer = (state={}, action)=>{
    switch(action.type){
        ...
        case EDIT_COMPANY_SUCCESS:
            return {...state, loading:false, companies:state.companies.map(company=>company.id===action.payload.id ? action.payload:company)}
        ...
        case CREATE_TEAM_SUCCESS:
            return {...state, loading:false, company:{...state.company, teams:[...state.company.teams, action.payload]}}
        ...
        case EDIT_TEAM_SUCCESS:
            return {...state, loading:false, company:{...state.company, teams:state.company.teams.map(team=> team.id===action.payload.id? action.payload: team)}}
        case EDIT_TEAM_FAIL:
            return {...state, loading:false, error:action.payload}
        ...
        case DELETE_TEAM_SUCCESS:
            return {...state, loading:false, company:{...state.company, teams:state.company.teams.filter(team=> team.id!==action.payload)}}
